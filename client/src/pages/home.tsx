            ...
            <div className="relative">
              ...
              <div className="space-y-4 relative z-10">
                {[
                  ...
                  { n: "03", title: "Deposit BTC collateral", desc: "Send the required Bitcoin to the 3-of-3 multisignature address. The platform monitors the blockchain for confirmation of deposit and makes sure the required LTV is met.", Icon: Bitcoin },
