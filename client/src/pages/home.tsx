            ...
            <span className="text-gradient-gold">
              <span className="inline-flex items-center justify-center w-16 h-16 bg-orange-500 text-white font-bold rounded-full shadow-lg mr-2 relative">
                <svg viewBox="0 0 100 100" className="w-12 h-12 fill-white">
                  <path d="M63.04 39.741c.906-6.086-3.712-9.36-10.03-11.54l2.054-8.232-5.015-1.25-1.998 8.015c-1.317-.329-2.67-.639-4.016-.946L46.1 17.785l-5.016-1.25-2.054 8.232c-1.09-.249-2.158-.497-3.197-.756l.006-.022L29.463 22.4l-1.335 5.363s3.71.851 3.631 1.904c2.025.505 2.388 1.845 2.326 2.908l-2.33 9.339c.139.035.32.085.52.162-.168-.041-.348-.088-.535-.134l-3.265 13.104c-.248.612-.875 1.53-2.298 1.174.05.072-3.632-1.905-3.632-1.905l-2.484 5.75 5.188 1.293c.965.241 1.91.494 2.838.731l-2.081 8.345 5.016 1.25 2.054-8.232c1.367.372 2.692.715 3.988 1.035l-2.046 8.203 5.016 1.25 2.081-8.332c8.583 1.623 15.034.97 17.757-6.804 2.194-6.257-.109-9.87-4.634-12.223 3.294-.76 5.772-2.932 6.437-7.426zm-11.511 16.133c-1.556 6.249-12.078 2.872-15.486 2.023l2.759-11.062c3.408.85 14.331 2.53 12.727 9.04zM65.22 39.616c-1.418 5.696-10.185 2.805-13.021 2.093l2.5-10.02c2.837.71 11.984 2.03 10.52 7.927z"/>
                </svg>
              </span>
              itcoin-Backed Loans
            </span>
