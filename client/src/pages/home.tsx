        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            ...
            <span className="text-gradient-gold">
              <span className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-b from-orange-400 to-orange-600 text-white font-bold rounded-full border-2 border-orange-500 shadow-lg mr-2 relative">
                <svg viewBox="0 0 64 64" className="w-10 h-10 fill-white">
                  <path d="M32 0C14.327 0 0 14.327 0 32s14.327 32 32 32 32-14.327 32-32S49.673 0 32 0zm11.021 26.284c.728-4.864-2.977-7.477-8.032-9.214L36.34 12.2l-3.287-.819-1.35 5.417c-.863-.216-1.75-.419-2.631-.621l1.36-5.456-3.287-.819-1.351 5.417c-.715-.163-1.417-.323-2.096-.491l.004-.018-4.532-1.13-.874 3.507s2.432.558 2.38.592c1.327.331 1.566 1.209 1.527 1.906l-1.53 6.138c.092.023.21.057.341.11-.11-.027-.228-.058-.35-.089l-2.143 8.598c-.163.402-.575.995-1.506.769.033.047-2.38-.594-2.38-.594l-1.63 3.756 4.278 1.065c.795.199 1.574.406 2.34.6l-1.363 5.478 3.287.819 1.351-5.417c.896.243 1.764.467 2.613.678l-1.346 5.398 3.287.819 1.363-5.470c5.623 1.063 9.848.635 11.631-4.447 1.438-4.098-.071-6.464-3.034-8.002 2.157-.498 3.78-1.921 4.213-4.854zm-7.542 10.573c-1.02 4.09-7.912 1.879-10.14 1.324l1.809-7.252c2.228.556 9.396 1.653 8.331 5.928zm1.02-10.628c-.929 3.728-6.669 1.834-8.528 1.369l1.64-6.576c1.859.464 7.848 1.329 6.888 5.207z"/>
                </svg>
              </span>
              itcoin-Backed Loans
            </span>
