...
export default function Navigation() {
  ...
  return (
    <nav className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-md shadow-lg border-b border-white/20 dark:border-gray-700/50 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-28">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2" onClick={() => setMobileMenuOpen(false)}>
              <img src={logoImage} alt="Reconquest" className="h-24 w-auto rounded-lg bg-white/90 dark:bg-white/95 p-1" />
            </Link>
